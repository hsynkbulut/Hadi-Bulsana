...
class TenantAboutPage extends StatefulWidget {
  const TenantAboutPage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _TenantAboutPageState createState() => _TenantAboutPageState();
}

class _TenantAboutPageState extends State<TenantAboutPage> {
  @override
