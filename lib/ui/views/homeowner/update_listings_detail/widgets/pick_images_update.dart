...
class PickImagesUpdateScreen extends StatefulWidget {
  final UpdateHouseListViewModel viewModel;

  const PickImagesUpdateScreen({
    Key? key,
    required this.viewModel,
  }) : super(key: key);

  @override
  State<PickImagesUpdateScreen> createState() => _PickImagesUpdateScreenState();
}

class _PickImagesUpdateScreenState extends State<PickImagesUpdateScreen> {
